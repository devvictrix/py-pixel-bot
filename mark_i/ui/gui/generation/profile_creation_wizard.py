...
class ProfileCreationWizardWindow(ctk.CTkToplevel):
    ...
    def _render_step_logic_editors(self, condition_data: Dict[str,Any], action_data: Dict[str,Any], element_to_refine_description: Optional[str]):
        ...
        cond_menu = ctk.CTkOptionMenu(self.step_logic_condition_frame, variable=cond_type_var, values=ALL_CONDITION_TYPES_FROM_CONFIG, command=lambda choice: self._on_wizard_logic_type_change("condition", choice))
        ...
        act_menu = ctk.CTkOptionMenu(self.step_logic_action_frame, variable=act_type_var, values=ALL_ACTION_TYPES_FROM_CONFIG, command=lambda choice: self._on_wizard_logic_type_change("action", choice))
