...
logger = logging.getLogger(__name__) # Using __name__ for module-level logger
...
ACTION_TYPES = [
    ...
    "press_key",
    "log_message",
    "gemini_perform_task"  # AI-driven task execution (goal-based and NLU-based)
]
...
UI_PARAM_CONFIG: Dict[str, Dict[str, List[Dict[str, Any]]]] = {
    "conditions": {
        ...
        "template_match_found": [
            {"id": "template_name", "label": "Template Name:", "widget": "optionmenu_dynamic", "options_source": "templates", "type": str, "default": "", "required": True},
        ...
        "ocr_contains_text": [
            {"id": "text_to_find", "label": "Text to Find (CSV for OR):", "widget": "entry", "type": str, "default": "", "required": True, "placeholder": "keyword1,another keyword"},
            {"id": "case_sensitive", "label": "Case Sensitive Search", "widget": "checkbox", "type": bool, "default": False, "required": False},
            {"id": "min_ocr_confidence", "label": "Min OCR Confidence (0-100, Optional):", "widget": "entry", "type": float, "default": 70.0, "required": False, "allow_empty_string": True, "min_val": 0.0, "max_val": 100.0, "placeholder": "e.g., 70.0"},
            {"id": "capture_as", "label": "Capture Full OCR Text As:", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "Optional variable name"},
            {"id": "region", "label": "Target Region (Override):", "widget": "optionmenu_dynamic", "options_source": "regions", "type": str, "default": "", "required": False},
        ],
        "dominant_color_matches": [
            ...
            {"id": "min_percentage", "label": "Min % Occurrence (0-100):", "widget": "entry", "type": float, "default": 5.0, "required": False, "min_val": 0.0, "max_val": 100.0, "placeholder": "5.0"},
            {"id": "region", "label": "Target Region (Override):", "widget": "optionmenu_dynamic", "options_source": "regions", "type": str, "default": "", "required": False},
        ],
        "gemini_vision_query": [
            {"id": "prompt", "label": "Gemini Vision Prompt:", "widget": "textbox", "type": str, "default": "Describe this image in detail.", "required": True, "placeholder": "e.g., Is there a login button visible? If so, describe it.", "height": 100},
            {"id": "expected_response_contains", "label": "Response Contains (CSV for OR, Optional):", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "keyword1,keyword2"},
            ...
            {"id": "expected_response_json_path", "label": "JSON Path in Response (Dot Notation, Optional):", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "e.g., data.items.0.name"},
            {"id": "expected_json_value", "label": "Expected JSON Value (String, Optional):", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "Value at JSON path"},
            {"id": "capture_as", "label": "Capture Gemini Response As:", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "Optional variable name"},
            {"id": "model_name", "label": "Gemini Model (Override Profile Default, Optional):", "widget": "entry", "type": str, "default": "", "required": False, "allow_empty_string": True, "placeholder": "e.g., gemini-1.5-pro-latest"},
            {"id": "region", "label": "Target Region (Override):", "widget": "optionmenu_dynamic", "options_source": "regions", "type": str, "default": "", "required": False},
        ],
        "always_true": [ # Often used for unconditional actions or as a base for compound conditions
            {"id": "region", "label": "Context Region (Optional Override):", "widget": "optionmenu_dynamic", "options_source": "regions", "type": str, "default": "", "required": False, "placeholder":"Usually not needed for always_true"}
        ],
    },
    "actions": {
        "click": [
            {"id": "target_relation", "label": "Target Relation:", "widget": "optionmenu_static", "options_const_key": "CLICK_TARGET_RELATIONS", "type": str, "default": "center_of_region", "required": True},
            {"id": "target_region", "label": "Target Region (if relation needs it):", "widget": "optionmenu_dynamic", "options_source": "regions", "type": str, "default": "", "required": False,
             "condition_show": {"field_id_prefix": "act_", "field": "target_relation", "values": ["center_of_region", "relative_to_region"]}},
            {"id": "x", "label": "X Coord/Offset (if relation needs it):", "widget": "entry", "type": str, "default": "0", "required": False, "allow_empty_string": True, "placeholder": "Abs/Rel X or {var}",
             "condition_show": {"field_id_prefix": "act_", "field": "target_relation", "values": ["absolute", "relative_to_region"]}},
            {"id": "y", "label": "Y Coord/Offset (if relation needs it):", "widget": "entry", "type": str, "default": "0", "required": False, "allow_empty_string": True, "placeholder": "Abs/Rel Y or {var}",
             "condition_show": {"field_id_prefix": "act_", "field": "target_relation", "values": ["absolute", "relative_to_region"]}},
            {"id": "gemini_element_variable", "label": "Gemini Element Variable (if relation needs it):", "widget": "entry", "type": str, "default": "", "required": False,
             "allow_empty_string": False, "placeholder": "e.g., captured_button_data",
            ...
            {"id": "pyautogui_pause_before", "label": "Pause Before Action (s):", "widget": "entry", "type": str, "default": "0.0", "required": False, "allow_empty_string": True, "placeholder": "0.0 or {var}"},
        ],
        "type_text": [
            {"id": "text", "label": "Text to Type:", "widget": "textbox", "type": str, "default": "", "required": True, "allow_empty_string": True, "placeholder": "Enter text here or use {variable}", "height": 80}, # Required, but can be empty string if allow_empty_string
            {"id": "interval", "label": "Interval Betw. Keystrokes (s):", "widget": "entry", "type": str, "default": "0.0", "required": False, "allow_empty_string": True, "placeholder": "0.0 or {var}"},
            {"id": "pyautogui_pause_before", "label": "Pause Before Action (s):", "widget": "entry", "type": str, "default": "0.0", "required": False, "allow_empty_string": True, "placeholder": "0.0 or {var}"},
        ],
        "press_key": [
            {"id": "key", "label": "Key(s) to Press (CSV for hotkey):", "widget": "entry", "type": str, "default": "enter", "required": True, "placeholder": "e.g., enter OR ctrl,alt,delete OR {my_key_var}"},
            {"id": "pyautogui_pause_before", "label": "Pause Before Action (s):", "widget": "entry", "type": str, "default": "0.0", "required": False, "allow_empty_string": True, "placeholder": "0.0 or {var}"},
        ],
        "log_message": [
            {"id": "message", "label": "Log Message:", "widget": "textbox", "type": str, "default": "Rule triggered log message.", "required": True, "allow_empty_string": True, "placeholder": "Your log message or {variable}", "height": 80 },
            {"id": "level", "label": "Log Level:", "widget": "optionmenu_static", "options_const_key": "LOG_LEVELS", "type": str, "default": "INFO", "required": True},
        ],
        "gemini_perform_task": [ # v4.0.0 Phase 2 & 3
            {"id": "natural_language_command", "label": "Natural Language Command for Gemini:", "widget": "textbox", "type": str, "default": "Example: Click the 'Next' button if it is visible.", "required": True, "height": 100, "placeholder": "Describe the task for Gemini..."},
            {"id": "goal_prompt", "label": "Simple Goal Prompt (Phase 2 Legacy - Optional):", "widget": "textbox", "type": str, "default": "", "required": False, "allow_empty_string": True, "height": 60, "placeholder": "If NLU command is empty, use this simple goal."},
            {"id": "context_region_names", "label": "Context Regions (CSV, Optional):", "widget": "entry", "type": "list_str_csv", "default": [], "required": False, "allow_empty_string": True, "placeholder": "region1,main_screen (uses rule default if empty)"},
            {"id": "allowed_actions_override", "label": "Allowed Sub-Actions by Gemini (CSV, Optional):", "widget": "entry", "type": "list_str_csv", "default": [], "required": False, "allow_empty_string": True, "placeholder": "e.g., CLICK_DESCRIBED_ELEMENT (see docs)"},
            ...
            {"id": "max_steps", "label": "Max NLU Task Steps:", "widget": "entry", "type": int, "default": 5, "required": False, "min_val":1, "max_val": 25, "placeholder": "5"},
            {"id": "pyautogui_pause_before", "label": "Pause Before Task Start (s):", "widget": "entry", "type": str, "default": "0.1", "required": False, "allow_empty_string": True, "placeholder": "0.1 or {var}"},
        ]
    },
}
...
OPTIONS_CONST_MAP: Dict[str, List[str]] = {
    ...
    "GEMINI_TASK_ALLOWED_ACTION_TYPES_FOR_UI": GEMINI_TASK_ALLOWED_PRIMITIVE_ACTIONS_FOR_UI_HINT, # For UI hints/tooltips
}