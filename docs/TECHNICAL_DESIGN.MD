...
- **End-to-End (Manual with Real API):** Test full workflow from user goal input -> plan generation -> interactive element definition -> final profile saving. Evaluate quality and usability of generated profiles.
